 ...
 *
 * No bank ships with this repository. Sound banks are user-local by decision —
 * architectural invariant 11 keeps SF2/SF3 bytes out of the Composition, and
 * MG-10 settled that redistribution needs a licence this project does not hold.
 * So the showcase names a bank rather than carrying one: with a matching bank
 * imported, all four Instruments sound; without one, MG-11's missing-bank
 * isolation reports it and the three native Instruments still play.
 */
