...
| MG-14 | Head-to-Head relations and continuous controls | MG-06, MG-07, MG-12 | `in_review` | Claude Opus 5 | 2026-08-05 | Implementation validated at `MG14_SHA`; browser check of relation and control authoring remains. |
...
| MG-14 | `MG14_SHA` | 37 files, 281 tests pass | pass | pass | 1,338 nodes / 2,741 edges | **Not yet run** — no browser automation reachable from this session; relation and Control Part authoring deserve a real-browser look | Pending |
