...
| MG-14 | `f2adb33` | 37 files, 281 tests pass | pass | pass | 1,338 nodes / 2,741 edges | **Not yet run** — no browser automation reachable from this session; relation and Control Part authoring deserve a real-browser look | Pending |
